...
//		list.add(new String[] {"잔류성/농축성/독성(PBTs)", "생태계에서 잘 없어지지 않고 먹이사슬을 통해 계속 축적되며, 사람 몸속에 들어와사 잘 빠져나가지 않는 독성물질"});
		list.add(new String[] {"사고대비물질", "독성과 폭발성이 강한 물질"});
		list.add(new String[] {"발암성", "암을 발생시키는 물질"});
		list.add(new String[] {"생식독성", "유산을 발생시키는 물질"});
		list.add(new String[] {"발달독성", "발달장애를 발생시키는 물질"});
		list.add(new String[] {"환경호르몬", "행동, 학습장애를 발생시키는 물질"});
		list.add(new String[] {"변이원성", "돌연변이를 발생시키는 물질"});
		list.add(new String[] {"잔류성/농축성", "몸에 축적되는 물질"});
	}
